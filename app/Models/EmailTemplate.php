...
class EmailTemplate extends Model
{
    ...
    public function replaceEmailContent($postData, $emailContent,$extraContentArr = NULL){
       ...
       $data = str_replace(array('#CUSTOMER_USERNAME','#CUSTOMER_FNAME','#CUSTOMER_LNAME','#CUSTOMER_EMAIL','#CUSTOMER_PHONE','#CUSTOMER_PASSWORD','#CUSTOMER_ADDRESS','#CUSTOMER_POSTCODE','#CUSTOMER_ORDER_SUMMARY'), array($username,$fname,$lname,$email,$phone,$password,$address,$postcode,$user_ordersummary),$emailContent);
