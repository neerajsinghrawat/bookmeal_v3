...
<meta name="csrf-token" content="{{ csrf_token() }}" />
    ...
    <?php if(isset($products->productItem) && count($products->productItem) >0 ) {
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="Item[{{ $key }}][description]" placeholder="Enter Item Description" >{{ $product_items->description }}</textarea> 
                </div> 
                <?php }else{?>
                <div class="item{{ $product_items->id }}">
                  <div class="form-group"><label for="exampleInputEmail1">Item Title</label><i class="fa fa-close delete_item" item_id="{{ $product_items->id }}" style="cursor:pointer;color: #d33b3b;float:right;"/></i>
                  <input type="text" class="form-control" value="{{ $product_items->title }}" name="Item[{{ $key }}][title]" placeholder="Enter Item Title">
                  </div>
...
<?php } } } else { ?>
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Item Description</label>
                  <textarea class="form-control" name="Item[1][description]" placeholder="Enter Item Description"></textarea> 
                </div> 
