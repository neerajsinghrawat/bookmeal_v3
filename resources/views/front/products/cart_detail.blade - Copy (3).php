        ...
        <div class="row">
            <div class="col-sm-12 ">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link {{ (Session::get('shoppingstep.step') == '')?'active':'dactive' }}" href="{{ (Session::get('shoppingstep.step') == '')?'#tab-cart':'' }}" >Cart</a></li>
                    <li class="nav-item"><a class="nav-link {{ (Session::get('shoppingstep.step') == 'step_1')?'active':'dactive' }}" href="{{ (Session::get('shoppingstep.step') == 'step_1')?'#tab-info':'' }}" >Delivery Address</a></li>
                    <li class="nav-item"><a class="nav-link {{ (Session::get('shoppingstep.step') == 'step_2')?'active':'dactive' }}" href="{{ (Session::get('shoppingstep.step') == 'step_2')?'#tab-payment':'' }}"  >payment method</a></li>
                </ul>
                <div class="bor"></div>
