                    ...
                    <div class="row">
                        <div class="col-sm-12 ">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item"><a class="nav-link {{ (Session::get('shoppingstep.step') == 'step_1')?'active':'' }}" href="#tab-info" data-toggle="tab"><span>2</span>Delivery Address</a></li>
                                <li class="nav-item"><a class="nav-link {{ (Session::get('shoppingstep.step') == 'step_2')?'active':'' }}" href="#tab-payment" data-toggle="tab"><span>3</span>payment method</a></li>
                            </ul>
                            <div class="bor"></div>
    ...
    {{ csrf_field() }}
                        ...
                        <h6 class="selectedDeliveryAddress">Default</h6>
                            <div class="form-group">
                                <label>Address</label>
                                <textarea name="user[address]" placeholder="Address" id="delivery_address" class="form-control" >{{ Auth::user()->address }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Post Code</label>
                                <input name="user[postcode]" placeholder="Post Code" id="delivery_code" class="form-control" type="text" value="{{ Auth::user()->postcode }}">
                            </div>
                            
                            <div class="form-group">
                                <label>Phone</label>
                                <input name="user[phone]" placeholder="Post Code" id="delivery_phone" class="form-control" type="text" value="{{ Auth::user()->phone }}">
                            </div>
                        <input name="user[address_id]"  id="delivery_address_id" class="form-control" type="hidden" value="0">
                        </fieldset>
